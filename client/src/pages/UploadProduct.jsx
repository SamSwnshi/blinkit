...
const UploadProduct = () => {
  ...
  return (
    <section>
      <div className="p-2   bg-green-800 text-white shadow-md flex items-center justify-between">
      ...
      <div className="grid p-3">
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div
            ...
            className=" hover:bg-orange-400 bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 hover:text-neutral-900 cursor-pointer rounded"
          >
            Add Fields
          </div>

          <button className="bg-blue-300 hover:bg-blue-500 py-2 rounded font-semibold hover:text-white">
            Submit
          </button>
        </form>
      </div>
