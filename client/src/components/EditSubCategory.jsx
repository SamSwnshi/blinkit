    ...
    <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800 bg-opacity-70 z-50 flex items-center justify-center p-4'>
        <div className='w-full max-w-5xl bg-green-800 p-4 rounded'>
            <div className='flex items-center justify-between gap-3'>
                <h1 className='font-semibold text-white'>Edit Sub Category</h1>
            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <button
                        className={`px-4 py-2 border
                            ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? "bg-white hover:bg-black hover:text-white" : "bg-gray-200"}    
                            font-semibold
                        `}
                    >
                        Submit
