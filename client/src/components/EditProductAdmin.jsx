...
import successAlert from "../utils/success";
...
const EditProductAdmin = ({ close, data: propsData, fetchProductData }) => {
  ...
  return (
    <section className="fixed top-0 right-0 left-0 bottom-0  z-50 bg-opacity-70 p-4">
      <div className="bg-green-800 w-full p-4 max-w-2xl mx-auto  overflow-y-auto h-full max-h-[95vh]">
        ...
        <div className="grid p-3">
          <form className="grid gap-4" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-1">
              <label htmlFor="unit" className="font-medium text-white">
                Unit
              </label>
              <input
                id="unit"
            ...
            <div className="grid gap-1">
              <label htmlFor="stock" className="font-medium text-white">
                Number of Stock
              </label>
              <input
                id="stock"
            ...
            <div className="grid gap-1">
              <label htmlFor="discount" className="font-medium text-white">
                Discount
              </label>
              <input
                id="discount"
            ...
            {Object?.keys(data?.more_details)?.map((k, index) => {
              return (
                <div className="grid gap-1">
                  <label htmlFor={k} className="font-medium text-white">
                    {k}
                  </label>
                  <input
                    id={k}
            ...
            <button className="bg-white hover:bg-black hover:text-white py-2 rounded font-semibold">
              Update Product
            </button>
          </form>
        </div>
