...
const CardProduct = ({ data }) => {
  ...
  return (
    <Link to={url} className='border border-gray-500  py-2 lg:p-4 grid gap-1 lg:gap-3 min-w-36 lg:min-w-52 rounded cursor-pointer bg-white hover:scale-105 duration-300' >
